	...
	public static void main(String[] args){
		...
		try {
			...
			while (true) {
				...
				System.out.println("put Test "+ i + ", Test "+ i+1 + ": " + client.put("Test" + i, "Test" + (i+1)));
				System.out.println("put Test "+ i + ", Test "+ i+2 + ": " + client.put("Test" + i, "Test" + (i+2)));
				try {
					System.out.println("second get Test " + i + ": " + client.get("Test" + i));
				} catch (Exception e) {
